#ifndef CODIFICACIONMETODOS_H
#define CODIFICACIONMETODOS_H
...
void codMet1(unsigned char *ptr1, unsigned int tam,short int n){
    unsigned char temp;
    short int ban;
    short int cont;
    short int cont2;
...
void codMet2(unsigned char *ptr, unsigned int tam, short int n){
    // (arrayEnBloques,tam,semilla)
    unsigned char temp = (char)(0);
    unsigned char mascara = (char)(1);
